...
#define SCALE_FACTOR_X (64.0 / 128.0)
#define SCALE_FACTOR_Y (32.0 / 64.0)
// Clock
#define CLOCK_X 0
#define CLOCK_Y 6
...
#define WEATHER_TODAY_X 48
#define WEATHER_TODAY_Y 0

#define WEATHER_FORECAST_X 32
